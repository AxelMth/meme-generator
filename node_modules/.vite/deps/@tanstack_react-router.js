...
function useLinkProps(options, forwardedRef) {
  ...
  const viewportIntersectionCallback = React10.useCallback(
    (entry) => {
...
var MatchInner = React12.memo(function MatchInnerImpl({
  ...
  const out = React12.useMemo(() => {
    ...
    return Comp ? (0, import_jsx_runtime8.jsx)(Comp, {}, matchId) : (0, import_jsx_runtime8.jsx)(Outlet, {});
...
function Matches() {
  ...
  const ResolvedSuspense = !router.state.matches.length ? React13.Suspense : SafeFragment;
